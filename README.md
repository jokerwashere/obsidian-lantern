...
- **A desktop Obsidian vault on the local filesystem.** Lantern is desktop-only (it shells out to the qmd binary). minAppVersion **1.2.0**.
...
- Run **Lantern: Open search** or **Lantern: Open chat** (command palette), or open the Lantern pane.

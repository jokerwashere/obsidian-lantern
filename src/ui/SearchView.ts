...
export class LanternView extends ItemView {
	...
	private buildSearchControls(parent: HTMLElement): void {
		...
		this.rerankChip.addEventListener("click", async () => {
		...
		recentChip.addEventListener("click", async () => {
	...
	private buildChatControls(parent: HTMLElement): void {
		...
		this.webChip.addEventListener("click", async () => {
		...
		this.writeChip.addEventListener("click", async () => {
	...
	private renderResultCard(container: HTMLElement, result: QmdResult): void {
		...
		title.addEventListener("click", () => this.openResult(result));
